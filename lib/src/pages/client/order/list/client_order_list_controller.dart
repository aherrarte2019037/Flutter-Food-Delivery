...
import 'package:food_delivery/src/pages/client/order/detail/client_order_detail_page.dart';
...
class ClientOrderListController {
  ...
  Map<OrderStatus, Icon> statusIcons = {
    OrderStatus.pagado    : const Icon(FlutterIcons.md_card_ion, size: 24, color: Colors.greenAccent),
  ...
  Map<OrderStatus, Color> statusColors = {
    OrderStatus.pagado    : Colors.greenAccent,
  ...
  void showOrderDetailModal(Order order) {
    showMaterialModalBottomSheet(
      enableDrag: false,
      context: context,
      builder: (_) =>  ClientOrderDetailPage(order: order, updateParentOrders: updateOrdersGrouped),
    );
  }
