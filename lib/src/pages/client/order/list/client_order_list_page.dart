...
import 'package:food_delivery/src/pages/client/order/list/client_order_list_controller.dart';
...
class ClientOrderListPage extends StatefulWidget {
  ...
  @override
  _ClientOrderListPageState createState() => _ClientOrderListPageState();
}
...
class _ClientOrderListPageState extends State<ClientOrderListPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/images/client-order-list.gif'),
          fit: BoxFit.cover,
  ...
  Widget _orderCard(Order order) {
    String delivery = '${order.delivery?.firstName.capitalize()} ${order.delivery?.lastName[0].capitalize()}.';
    if (order.delivery?.firstName == null && order.delivery?.lastName == null) delivery = 'No Asignado';
