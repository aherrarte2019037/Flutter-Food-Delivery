...
import 'package:food_delivery/src/pages/delivery/order/detail/delivery_order_detail_controller.dart';
...
class DeliveryOrderDetailPage extends StatefulWidget {
  ...
  const DeliveryOrderDetailPage({Key? key, required this.order, required this.updateParentOrders}) : super(key: key);

  @override
  _DeliveryOrderDetailPageState createState() => _DeliveryOrderDetailPageState();
}
