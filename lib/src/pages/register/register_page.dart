                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [_registerButton(), const SizedBox(height: 5), _loginSection()],
                            ),
                          ],
                        ),
                      ),
    ...
    return Flexible(
      child: Container(
          ...
          child: TextField(
            ...
            onEditingComplete: () {
              _registerController.fieldFocusChange(context, _registerController.firstNameNode, _registerController.lastNameNode);
            },
    ...
    return Flexible(
      child: Container(
          ...
          child: TextField(
            ...
            textInputAction: TextInputAction.next,
            onEditingComplete: () {
              _registerController.fieldFocusChange(context, _registerController.lastNameNode, _registerController.emailNode);
            },
            textCapitalization: TextCapitalization.words,
  ...
  Widget _textFieldEmail() {
    return Container(
        ...
        child: TextField(
          ...
          textInputAction: TextInputAction.next,
          onEditingComplete: () {
              _registerController.fieldFocusChange(context, _registerController.emailNode, _registerController.passwordNode);
          },
  ...
  Widget _textFieldPassword() {
    return Container(
        ...
        child: TextField(
          ...
          textInputAction: TextInputAction.next,
          onEditingComplete: () {
              _registerController.fieldFocusChange(context, _registerController.passwordNode, _registerController.confirmNode);
          },
